 ...
 * https://github.com/BinaryMoon/browser-shots/blob/master/browser-shots.php#L176-L202
 * and
 * https://github.com/Automattic/mShots/blob/master/public_html/class-mshots.php
 * 
 ...
 * @return string
 */
function get_shot( $url = '', $width = 600, $height = 450, $new_name = '' ) : string {
	...
	if ( '' !== $url ) {
		...
		#$local_url  = $this->save_screenshot( $remote_url, $new_name );
